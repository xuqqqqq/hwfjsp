...
No new Pareto point exceeded the current high-output best `pareto_18932_826.json`, but tail-sacrifice probes improved the low-setup region to `18766.98 / 768` and added an adjacent `18771.72 / 802` tradeoff.
